...
export const MenuDropdown: React.FC<MenuDropdownProps> = ({ onExitChat, onMenuStateChange }) => {
          ...
          >
            <div className="px-4 py-3">
              ...
              <div className="flex items-center justify-between mb-2">
                <h2 id="menu-title" className="text-base sm:text-lg font-medium text-gray-700 px-1">더보기</h2>
                <button
                  onClick={() => setIsOpen(false)}
              ...
              <div>
                ...
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-red-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
